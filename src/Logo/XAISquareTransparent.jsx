...
const XAISquareTransparent = ({ fill = {}, w = 45, h = 45, title = 'xAI' }) => (
    <svg
        style={fill}
        role="img"
        viewBox="0 0 600 600"
        ...
        <title>{title}</title>
        <g clipPath="url(#svg-logo-xai-square-transparent-clip)">
        ...
        <defs>
            <clipPath id="svg-logo-xai-square-transparent-clip">
...
export default XAISquareTransparent
